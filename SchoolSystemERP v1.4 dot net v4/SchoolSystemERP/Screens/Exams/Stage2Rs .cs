...
{
    //نتيجة المراحل الاول .التاني الثالث
    public partial class Stage2Rs : Form
    {
        #region vars
        private readonly GenericRepository repo = new GenericRepository();
        private static Stage2Rs frm;
        private int _key = 0;
        #endregion
        #region frm helper
        ...
        public static Stage2Rs GetAttendenceSt
        {
            get
            {
                if (frm == null)
        ...
        public Stage2Rs()
        {
            ...
            repo.DisplayAllq("Stage2RSTbl", StResultsDGV);
        ...
        private void GetStuName()
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                StageCb.SelectedItem = dr["StClass"].ToString();
        ...
        private void StResultsDGV_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            EnglishTb.Text = StResultsDGV.SelectedRows[0].Cells[6].Value.ToString();
            DiscoverTb.Text = StResultsDGV.SelectedRows[0].Cells[7].Value.ToString();
            RelgionTb.Text = StResultsDGV.SelectedRows[0].Cells[8].Value.ToString();
        ...
        {
            // TODO: This line of code loads data into the 'schoolDBDataSet3.Stage2RSTbl' table. You can move, or remove it, as needed.
            _ = stage2RSTblTableAdapter.Fill(schoolDBDataSet3.Stage2RSTbl);
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("insert into Stage2RSTbl(StId,StName,StStage,Arabic,Math,English,Discover,Relgion,RMonth)values(@StId,@Sname,@StStage,@Arabic,@Math,@English,@Discover,@Relgion,@RMonth)", repo._db.conn);
        ...
        private void EditResult_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("update  Stage2RSTbl set StId=@StId,StName=@Sname,StStage=@StStage,Arabic=@Arabic,Math=@Math,English=@English,Discover=@Discover,Relgion=@Relgion,RMonth=@RMonth where ResId=@rsid", repo._db.conn);
                    _ = cmd.Parameters.AddWithValue("@StId", StdIdCb.SelectedValue);
                    _ = cmd.Parameters.AddWithValue("@Sname", StNameTb.Text);
                    _ = cmd.Parameters.AddWithValue("@StStage", StageCb.SelectedItem.ToString());
                    _ = cmd.Parameters.AddWithValue("@Arabic", ArabicTb.Text);
        ...
        private void DeleteBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("delete from Stage2RSTbl where ResId=@rsid", repo._db.conn);
                    _ = cmd.Parameters.AddWithValue("@rsid", _key);
                    _ = cmd.ExecuteNonQuery();
        ...
        {
            repo.SerachST("Stage2RSTbl", StResultsDGV, searchtxt.Text);
        }
        #endregion
