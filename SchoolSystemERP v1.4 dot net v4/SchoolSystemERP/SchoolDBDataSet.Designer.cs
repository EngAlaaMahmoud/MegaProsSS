...
SELECT StId, StName, StGen, StDOB, StClass, StMobile, StAdd, StFeesBook, StFeesCloth, StFeesBus, StFees, StFeesM1, StFeesM2, StFeesM3, StFeesM4, StFeesM5, StFeesTotal FROM StudentTbl WHERE (StId = @StId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT StId, StName, StGen, StDOB, StClass, StMobile, StAdd, StFeesBook, StFeesCl" +
                "oth, StFeesBus, StFees, StFeesM1, StFeesM2, StFeesM3, StFeesM4, StFeesM5, StFees" +
                "Total \r\nFROM dbo.StudentTbl \r\nwhere (StName Like \'%\' +@Value+\'%\')";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Value", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "StName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByName(SchoolDBDataSet.StudentTblDataTable dataTable, string Value) {
        ...
        public virtual SchoolDBDataSet.StudentTblDataTable GetDataByName(string Value) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((Value == null)) {
                throw new global::System.ArgumentNullException("Value");
            }
